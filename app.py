...
# Initial input prompt for the ]Xray Analyst
input_prompt = """
...
If the user insert image other than Xray then you should not analyze the image.You should tell that the upload image is not and Xray Image.
